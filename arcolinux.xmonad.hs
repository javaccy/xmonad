...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((0, xK_F12), spawn $ "guake-toggle" )
  , ((0, xK_F10), spawn $ "terminology -M" )
...
--  , ((0, xF86XK_AudioStop), spawn $ "playerctl stop")
  ...
  -- swap yancc next 
  , ((controlMask .|. modMask, xK_Return), windows $ W.swapUp . W.focusDown  )
  -- swap yancc prev
  , ((modMask, xK_Return), windows $ W.swapDown . W.focusUp  )
